...
import booking.beans.services.impl.BookingServiceImpl;
...
public class TestBookingServiceConfig {
    ...
    public Event testEvent1() {
        return new Event(1, "Test event", booking.beans.models.Rate.HIGH, 124.0, java.time.LocalDateTime.of(2016, 2, 6, 14, 45, 0),
                         testHall1());
    }
